...
public class TEST_Requirement {
	...
	@Test public void TEST_Accessors() {
		Requirement requirement = new Requirement( "Description", "Stakeholder", Priority.HIGH, Status.ACCEPTED_CURRENT,
				false );
		...
		assertEquals( false, requirement.isFulfilled() );
		...
		assertEquals( true, requirement.isFulfilled() );
	}
}
